...
declare var $ :any;
@Component({
  selector: 'app-gi-non-verified-meter-readers',
  templateUrl: './gi-non-verified-meter-readers.component.html',
  styleUrls: ['./gi-non-verified-meter-readers.component.css']
})
export class GiNonVerifiedMeterReadersComponent implements OnInit {
