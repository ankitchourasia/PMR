...
@Component({
  selector: 'app-assign-complete-group-to-reader-gi',
  templateUrl: './assign-complete-group-to-reader-gi.component.html',
  styleUrls: ['./assign-complete-group-to-reader-gi.component.css']
})
export class AssignCompleteGroupToReaderGIComponent implements OnInit {
