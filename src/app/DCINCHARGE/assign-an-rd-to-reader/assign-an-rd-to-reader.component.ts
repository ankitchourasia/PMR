...
@Component({
  selector: 'app-assign-an-rd-to-reader',
  templateUrl: './assign-an-rd-to-reader.component.html',
  styleUrls: ['./assign-an-rd-to-reader.component.css']
})
export class AssignAnRdToReaderComponent implements OnInit {
