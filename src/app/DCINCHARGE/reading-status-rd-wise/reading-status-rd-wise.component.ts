...
@Component({
  selector: 'app-reading-status-rd-wise',
  templateUrl: './reading-status-rd-wise.component.html',
  styleUrls: ['./reading-status-rd-wise.component.css']
})
export class ReadingStatusRdWiseComponent implements OnInit {
...
billMonths = GlobalConstants.billMonths;
  ...
  getReadingStatus()
  {
    ...
    return this.http.post("api/dc-incharge-reports/group-rd-wise-count-dashboard", formdata, {headers:new HttpHeaders().set('Authorization',this.session.get('token'))}).subscribe(response=>
    {
      this.resp=response;
      if(this.resp!='')
  {
