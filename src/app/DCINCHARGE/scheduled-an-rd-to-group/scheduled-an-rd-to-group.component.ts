...
declare var $ :any;
@Component({
  selector: 'app-scheduled-an-rd-to-group',
  templateUrl: './scheduled-an-rd-to-group.component.html',
  styleUrls: ['./scheduled-an-rd-to-group.component.css']
})
export class ScheduledAnRdToGroupComponent implements OnInit {
...
billMonths = GlobalConstants.billMonths;
  ...
  submitScheduled()
  {
    ...
    {
    alert(this.resp.msg);
    this.router.navigate(['/schedule-a-single-rd-in-group']);
    }
    else
    {
      // alert(this.resp.msg);
