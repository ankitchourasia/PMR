...
declare var $ :any;
@Component({
  selector: 'app-meternotfound-reading-assesment',
  templateUrl: './meternotfound-reading-assesment.component.html',
  styleUrls: ['./meternotfound-reading-assesment.component.css']
})
export class MeternotfoundReadingAssesmentComponent implements OnInit {
