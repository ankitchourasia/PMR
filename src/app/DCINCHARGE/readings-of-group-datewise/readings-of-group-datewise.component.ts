...
declare var $ :any;
@Component({
  selector: 'app-readings-of-group-datewise',
  templateUrl: './readings-of-group-datewise.component.html',
  styleUrls: ['./readings-of-group-datewise.component.css']
})
export class ReadingsOfGroupDatewiseComponent implements OnInit {
