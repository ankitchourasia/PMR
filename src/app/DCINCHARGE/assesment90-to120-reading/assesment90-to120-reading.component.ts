...
declare var $ :any;
@Component({
  selector: 'app-assesment90-to120-reading',
  templateUrl: './assesment90-to120-reading.component.html',
  styleUrls: ['./assesment90-to120-reading.component.css']
})
export class Assesment90To120ReadingComponent implements OnInit {
...
exportAsXsls(): void {
  this.exportService.exportAsExcelFile(this.resp, 'assesment90 to 120'+this.groupno+"_"+this.billmonth);
