...
@Component({
  selector: 'app-de-change-password',
  templateUrl: './de-change-password.component.html',
  styleUrls: ['./de-change-password.component.css']
})
export class DeChangePasswordComponent implements OnInit {
